...
eval { $x->diagnostic_has_question(1); };
like($@, qr/^Knowledge->diagnostic_has_question\(\) takes no arguments /, 'Too many arguments');
...
is($x->diagnostic_has_question(), '1', 'The question is now set');
...
is($x->diagnostic_has_question(), '1', 'The question has not been answered');
...
is($x->diagnostic_has_question(), '1', 'The question has been answered');
...
is($x->diagnostic_has_question(), '1', 'The question has been set');
is($x->is_value_set(), '', 'Value is not set');
